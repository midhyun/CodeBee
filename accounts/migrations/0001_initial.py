    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=13, null=True, validators=[django.core.validators.MinLengthValidator(11), django.core.validators.MaxLengthValidator(11), accounts.models.input_only_number])),
                ('profile_picture', imagekit.models.fields.ProcessedImageField(null=True, upload_to='profile_pictures/')),
                ('address', models.CharField(max_length=100)),
                ('detail_address', models.CharField(max_length=30)),
                ('location', models.CharField(max_length=100, null=True)),
                ('is_social_account', models.BooleanField(default=False)),
                ('git_username', models.CharField(max_length=50, null=True)),
                ('boj_username', models.CharField(max_length=50, null=True)),
